...
use nexus_api::{BlockId, FileEntry, FileType, Value, format_value_for_display};
...
use strata::layout::{
    ...
    ScrollColumn, TextElement, TextInputElement, VirtualTableElement, VirtualCell, Widget,
};
