...
mod tests {
    ...
    fn test_extract_fragments_from_structured_message_with_tool_use() {
        ...
        let message = nexus_llm::Message::new_assistant_content(vec![
            nexus_llm::ContentBlock::new_text("I'll read the file for you."),
            nexus_llm::ContentBlock::new_tool_use("tool_123", "read_files", tool_input),
        ]);
    ...
    fn test_extract_fragments_from_mixed_structured_message() {
        ...
        let message = nexus_llm::Message::new_assistant_content(vec![
            nexus_llm::ContentBlock::new_thinking("Let me think about this request.", "sig"),
            nexus_llm::ContentBlock::new_text(
            ...
            nexus_llm::ContentBlock::new_text("File has been written."),
        ]);
