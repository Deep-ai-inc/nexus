...
mod tests {
    ...
    fn test_extract_fragments_from_text_message_with_xml_tags() {
        ...
        let message = nexus_llm::Message::new_assistant(
    ...
    fn test_extract_fragments_from_structured_message_converted_to_xml_style() {
        ...
        let message = nexus_llm::Message::new_assistant_content(vec![
            nexus_llm::ContentBlock::new_text("I'll search the files."),
            nexus_llm::ContentBlock::new_tool_use("search_456", "search_files", tool_input),
        ])
        .with_request_id(1);
    ...
    fn test_extract_fragments_from_mixed_structured_message() {
        ...
        let message = nexus_llm::Message::new_assistant_content(vec![
            nexus_llm::ContentBlock::new_thinking("I should write a file.", "sig"),
            nexus_llm::ContentBlock::new_text("Let me create the file. <thinking>What content should I write?</thinking> I'll write something useful."),
            nexus_llm::ContentBlock::new_tool_use(
                "write_789",
                "write_file",
                serde_json::json!({
                    "path": "test.txt",
