...
pub struct ChatMetadata {
    ...
    #[serde(default)]
    pub total_usage: nexus_llm::Usage,
    /// Usage from the last assistant message
    #[serde(default)]
    pub last_usage: nexus_llm::Usage,
...
fn calculate_session_usage(session: &ChatSession) -> (nexus_llm::Usage, nexus_llm::Usage, Option<u32>) {
...
mod tests {
    ...
    fn test_get_active_messages_cloned() {
        ...
        match &messages[0].content {
            nexus_llm::MessageContent::Text(text) => assert_eq!(text, "Hello"),
