...
impl From<&nexus_llm::ContentBlock> for ToolRequest {
    fn from(block: &nexus_llm::ContentBlock) -> Self {
        if let nexus_llm::ContentBlock::ToolUse {
            id, name, input, ..
        } = block
        {
            Self {
